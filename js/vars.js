...
// LOTTIE VARS
let teethLottie = { play: () => {}, pause: () => {} };
let cameraLottie = { play: () => {}, pause: () => {} };
let carLottie = { play: () => {}, pause: () => {} };
let eyesLottie = { play: () => {}, pause: () => {} };
let modalLottie = { play: () => {}, pause: () => {} };
let logoLottie = { play: () => {}, pause: () => {} };
